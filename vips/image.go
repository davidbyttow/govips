...
func (r *ImageRef) ImageFieldAsString(name string) string {
	return vipsImageGetFieldAsString(r.image, name)
}

func (r *ImageRef) ImageFieldSetString(name, value string) {
	vipsImageSetFieldString(r.image, name, value)
}
