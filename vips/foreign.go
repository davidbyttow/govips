...
// profile C string, if one was allocated.
func newSaveParamsWebP(in *C.VipsImage, params WebpExportParams) (C.struct_SaveParams, func()) {
...
func vipsSaveWebPToBuffer(in *C.VipsImage, params WebpExportParams) ([]byte, error) {
	...
	p, cleanup := newSaveParamsWebP(in, params)
	defer cleanup()
