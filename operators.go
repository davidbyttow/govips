 ...
 *
 * Generated at 12:40AM on December 28, 2016
 */
...
func (image Image) System(cmd_format string, options *Options) {
	if (options == nil) {
		options = NewOptions()
	}
	Call("system", options.
...
func (image Image) Black(width int, height int, options *Options) Image {
	var out Image;
	if (options == nil) {
		options = NewOptions()
	}
...
func (image Image) Gaussnoise(width int, height int, options *Options) Image {
	var out Image;
	if (options == nil) {
		options = NewOptions()
	}
...
func (image Image) Text(text string, options *Options) Image {
	var out Image;
	if (options == nil) {
		options = NewOptions()
	}
...
func (image Image) Xyz(width int, height int, options *Options) Image {
	var out Image;
	if (options == nil) {
		options = NewOptions()
	}
...
func (image Image) Gaussmat(sigma float64, min_ampl float64, options *Options) Image {
	var out Image;
	if (options == nil) {
		options = NewOptions()
	}
...
func (image Image) Logmat(sigma float64, min_ampl float64, options *Options) Image {
	var out Image;
	if (options == nil) {
		options = NewOptions()
	}
...
func (image Image) Eye(width int, height int, options *Options) Image {
	var out Image;
	if (options == nil) {
		options = NewOptions()
	}
...
func (image Image) Grey(width int, height int, options *Options) Image {
	var out Image;
	if (options == nil) {
		options = NewOptions()
	}
...
func (image Image) Zone(width int, height int, options *Options) Image {
	var out Image;
	if (options == nil) {
		options = NewOptions()
	}
...
func (image Image) Sines(width int, height int, options *Options) Image {
	var out Image;
	if (options == nil) {
		options = NewOptions()
	}
...
func (image Image) MaskIdeal(width int, height int, frequency_cutoff float64, options *Options) Image {
	var out Image;
	if (options == nil) {
		options = NewOptions()
	}
...
func (image Image) MaskIdealRing(width int, height int, frequency_cutoff float64, ringwidth float64, options *Options) Image {
	var out Image;
	if (options == nil) {
		options = NewOptions()
	}
...
func (image Image) MaskIdealBand(width int, height int, frequency_cutoff_x float64, frequency_cutoff_y float64, radius float64, options *Options) Image {
	var out Image;
	if (options == nil) {
		options = NewOptions()
	}
...
func (image Image) MaskButterworth(width int, height int, order float64, frequency_cutoff float64, amplitude_cutoff float64, options *Options) Image {
	var out Image;
	if (options == nil) {
		options = NewOptions()
	}
...
func (image Image) MaskButterworthRing(width int, height int, order float64, frequency_cutoff float64, amplitude_cutoff float64, ringwidth float64, options *Options) Image {
	var out Image;
	if (options == nil) {
		options = NewOptions()
	}
...
func (image Image) MaskButterworthBand(width int, height int, order float64, frequency_cutoff_x float64, frequency_cutoff_y float64, radius float64, amplitude_cutoff float64, options *Options) Image {
	var out Image;
	if (options == nil) {
		options = NewOptions()
	}
...
func (image Image) MaskGaussian(width int, height int, frequency_cutoff float64, amplitude_cutoff float64, options *Options) Image {
	var out Image;
	if (options == nil) {
		options = NewOptions()
	}
...
func (image Image) MaskGaussianRing(width int, height int, frequency_cutoff float64, amplitude_cutoff float64, ringwidth float64, options *Options) Image {
	var out Image;
	if (options == nil) {
		options = NewOptions()
	}
...
func (image Image) MaskGaussianBand(width int, height int, frequency_cutoff_x float64, frequency_cutoff_y float64, radius float64, amplitude_cutoff float64, options *Options) Image {
	var out Image;
	if (options == nil) {
		options = NewOptions()
	}
...
func (image Image) MaskFractal(width int, height int, fractal_dimension float64, options *Options) Image {
	var out Image;
	if (options == nil) {
		options = NewOptions()
	}
...
func (image Image) Tonelut(options *Options) Image {
	var out Image;
	if (options == nil) {
		options = NewOptions()
	}
...
func (image Image) Identity(options *Options) Image {
	var out Image;
	if (options == nil) {
		options = NewOptions()
	}
...
func (image Image) Fractsurf(width int, height int, fractal_dimension float64, options *Options) Image {
	var out Image;
	if (options == nil) {
		options = NewOptions()
	}
...
func (image Image) Worley(width int, height int, options *Options) Image {
	var out Image;
	if (options == nil) {
		options = NewOptions()
	}
...
func (image Image) Perlin(width int, height int, options *Options) Image {
	var out Image;
	if (options == nil) {
		options = NewOptions()
	}
...
func (image Image) Csvload(filename string, options *Options) Image {
	var out Image;
	if (options == nil) {
		options = NewOptions()
	}
...
func (image Image) Matrixload(filename string, options *Options) Image {
	var out Image;
	if (options == nil) {
		options = NewOptions()
	}
...
func (image Image) Rawload(filename string, width int, height int, bands int, options *Options) Image {
	var out Image;
	if (options == nil) {
		options = NewOptions()
	}
...
func (image Image) Vipsload(filename string, options *Options) Image {
	var out Image;
	if (options == nil) {
		options = NewOptions()
	}
...
func (image Image) Analyzeload(filename string, options *Options) Image {
	var out Image;
	if (options == nil) {
		options = NewOptions()
	}
...
func (image Image) Ppmload(filename string, options *Options) Image {
	var out Image;
	if (options == nil) {
		options = NewOptions()
	}
...
func (image Image) Radload(filename string, options *Options) Image {
	var out Image;
	if (options == nil) {
		options = NewOptions()
	}
...
func (image Image) Pdfload(filename string, options *Options) Image {
	var out Image;
	if (options == nil) {
		options = NewOptions()
	}
...
func (image Image) PdfloadBuffer(buffer Blob, options *Options) Image {
	var out Image;
	if (options == nil) {
		options = NewOptions()
	}
...
func (image Image) Svgload(filename string, options *Options) Image {
	var out Image;
	if (options == nil) {
		options = NewOptions()
	}
...
func (image Image) SvgloadBuffer(buffer Blob, options *Options) Image {
	var out Image;
	if (options == nil) {
		options = NewOptions()
	}
...
func (image Image) Gifload(filename string, options *Options) Image {
	var out Image;
	if (options == nil) {
		options = NewOptions()
	}
...
func (image Image) GifloadBuffer(buffer Blob, options *Options) Image {
	var out Image;
	if (options == nil) {
		options = NewOptions()
	}
...
func (image Image) Pngload(filename string, options *Options) Image {
	var out Image;
	if (options == nil) {
		options = NewOptions()
	}
...
func (image Image) PngloadBuffer(buffer Blob, options *Options) Image {
	var out Image;
	if (options == nil) {
		options = NewOptions()
	}
...
func (image Image) Jpegload(filename string, options *Options) Image {
	var out Image;
	if (options == nil) {
		options = NewOptions()
	}
...
func (image Image) JpegloadBuffer(buffer Blob, options *Options) Image {
	var out Image;
	if (options == nil) {
		options = NewOptions()
	}
...
func (image Image) Webpload(filename string, options *Options) Image {
	var out Image;
	if (options == nil) {
		options = NewOptions()
	}
...
func (image Image) WebploadBuffer(buffer Blob, options *Options) Image {
	var out Image;
	if (options == nil) {
		options = NewOptions()
	}
...
func (image Image) Tiffload(filename string, options *Options) Image {
	var out Image;
	if (options == nil) {
		options = NewOptions()
	}
...
func (image Image) TiffloadBuffer(buffer Blob, options *Options) Image {
	var out Image;
	if (options == nil) {
		options = NewOptions()
	}
...
func (image Image) Magickload(filename string, options *Options) Image {
	var out Image;
	if (options == nil) {
		options = NewOptions()
	}
...
func (image Image) MagickloadBuffer(buffer Blob, options *Options) Image {
	var out Image;
	if (options == nil) {
		options = NewOptions()
	}
